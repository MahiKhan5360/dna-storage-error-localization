...
axes[0].semilogy(history.history['binary_out_bit_error_rate'], label='Training BER')
axes[0].semilogy(history.history['val_binary_out_bit_error_rate'], label='Validation BER')
axes[0].set_xlabel('Epoch')
axes[0].set_ylabel('BER (log scale)')
axes[0].set_title('Hybrid Model BER')
axes[0].legend()
axes[0].grid(True, which="both", ls="--")
axes[1].plot(history.history['error_loc_error_localization_accuracy'], label='Training ELA')
axes[1].plot(history.history['val_error_loc_error_localization_accuracy'], label='Validation ELA')
axes[1].set_xlabel('Epoch')
axes[1].set_ylabel('ELA')
axes[1].set_title('Hybrid Model ELA')
axes[1].legend()
axes[1].grid(True)
plt.tight_layout()
plt.savefig('hybrid_transformer_lstm_enhanced.png', dpi=300)
plt.show()
